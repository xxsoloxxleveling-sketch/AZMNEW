...
import { ChevronDown, HelpCircle, FileText, Award, CheckCircle2, MessageCircle } from 'lucide-react';
...
export const FaqSection: React.FC<FaqSectionProps> = ({ onSelectTab }) => {
  ...
  const faqs = [
    ...
    {
      q: 'Where do the 100 MCQs in the written examination come from?',
      a: '100% of exam questions are derived directly from the official AZM Question Bank published for your specific class level (~1,000 MCQs course book covering Sciences, Math, English, General Knowledge, and Islamiat/Pak Studies). There are no out-of-syllabus surprise questions.'
    },
    {
      q: 'How does the 4-stage merit selection lifecycle work?',
      a: 'Merit is decided through 4 transparent phases: 1) Optical OMR Test (70% weight), 2) Past Academic DMC Record (10% weight), 3) Structured 6-Member Panel Interview (15% weight), and 4) Domicile & Need Verification (5% weight). The final ranked ledger is published openly with zero discretion.'
    },
    {
      q: 'Can students from private schools and colleges apply, or is it only for government schools?',
      a: 'Students from both government institutions and registered private schools across Khyber Pakhtunkhwa and Hazara Division are equally eligible to compete on pure merit.'
    },
    {
      q: 'When will the written test take place and how do I receive my Roll Number Slip?',
      a: 'Examinations will take place between 10 – 15 November 2026. Cryptographically verified Roll Number Slips with assigned test centers will be released on 25 October 2026 on this portal.'
    }
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <div className="text-center space-y-2">
          <span className="text-xs font-bold text-[#185b9d] uppercase tracking-widest">
            Admissions & Testing Guidance
          </span>
          <h2 className="text-2xl sm:text-4xl font-display font-extrabold text-slate-900 tracking-tight">
            Frequently Asked Questions
          </h2>
          <p className="text-xs sm:text-sm text-slate-600">
            Clear, transparent answers regarding Session V eligibility, test syllabus, OMR scoring, and scholarship awards.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className={`p-1.5 rounded-lg transition-transform ${isOpen ? 'rotate-180 bg-blue-50 text-[#185b9d]' : 'text-slate-400'}`}>
