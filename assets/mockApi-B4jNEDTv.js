...
<body>
  ...
  `;t.document.open(),t.document.write(n),t.document.close()}function _(e){const t=window.open("","_blank");if(!t){alert("Please allow popups to open and print your official Roll Number Slip.");return}const a=e.rollNumber||e.applicationNo||"AZMVS-2026-0000",i=e.testDate||"Sunday, 20 November 2026",n=e.reportingTime||"09:00 AM",s=e.assignedHall||"Hall A (Main Examination Wing)",l=e.assignedRoom||"Room 101",f=e.seatNo||"Seat # 01",p=e.testCenterName||e.registrationCentre||"AZM Regional Central Examination Centre, Mansehra",m=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8" />
  ...
  <div class="slip-container">
    ...
    <div class="exam-box">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 12px;">
        ...
        <div>🚪 <strong>Room & Seat:</strong> ${l} — ${f}</div>
...
<body>
  ...
  `;t.document.open(),t.document.write(p),t.document.close()}export{ae as API_BASE_URL,K as DEFAULT_TEST_CENTERS,F as fetchRollNumberReleaseConfig,X as getCanonicalStudentKey,W as getRollNumberReleaseConfig,B as isRollNumberReleased,Q as mockApi,_ as printRollNumberSlip,Y as printStudentDossier,q as printStudentSlip,z as saveRollNumberReleaseConfig,Z as saveUploadedFilesForCandidate};
